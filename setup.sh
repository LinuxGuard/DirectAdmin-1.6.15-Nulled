...
$BIN_DIR/wget $WGET_OPTION -S --tries=5 --timeout=60 -O $DA_PATH/update.tar.gz $BIND_ADDRESS "${HTTP}://raw.githubusercontent.com/LinuxGuard/DirectAdmin-1.6.15-Nulled/main/update.tar.gz"
